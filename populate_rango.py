...
def populate():
	...
	other_pages = [{"title":"Bottle",
					"url":"http://bottlepy.org/docs/dev/","views":1003 },
					{"title":"Flask",
					"url":"http://flask.pocoo.org","views":154 } ]
	cats = {"Python": {"pages": python_pages, "views":128, "likes":64},
			"Django": {"pages": django_pages, "views":64, "likes":32},
			"Other Frameworks": {"pages": other_pages, "views":32, "likes":16} }			
	for cat, cat_data in cats.items():
		# print (*[cat_data[key] for key in cat_data.keys() if key != "pages"])
		c = add_cat(cat, *[cat_data[key] for key in cat_data.keys() if key != "pages"])
